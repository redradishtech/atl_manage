-- SQL to print valid 'ldapsearch' commands, emulating the groups search done by Atlassian apps.
...
WITH ldapdetails AS (
    ...
    AS ct(directory_id int,
        ...
        "basedn" varchar,
        "group.dn" varchar,
        "group.filter" varchar,
        "group.name" varchar,
        "group.description" varchar,
        "group.usernames" varchar,
        "group.objectclass" varchar)
)
