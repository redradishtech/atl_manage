...
export destination_type=replication
export destination_type_rootdir="$ATL_APPDIR/replication"
export SOURCE=ATL_REPLICATION_PRIMARY
export DESTINATION=ATL_REPLICATION_STANDBY
export SOURCE_HOST=ATL_REPLICATION_PRIMARY_HOST
export SOURCE_HOST_UNAME=ATL_REPLICATION_PRIMARY_HOST_UNAME
export SOURCE_SYNCUSER=ATL_REPLICATION_PRIMARY_SYNCUSER
export DESTINATION_SYNCUSER=ATL_REPLICATION_STANDBY_SYNCUSER
export DESTINATION_HOST=ATL_REPLICATION_STANDBY_HOST
export DESTINATION_PORT=ATL_REPLICATION_STANDBY_PORT
export DESTINATION_HOST_UNAME=ATL_REPLICATION_STANDBY_HOST_UNAME
export DESTINATION_APPDIR_BASE=ATL_REPLICATION_STANDBY_APPDIR_BASE
export SYNCUSER=ATL_REPLICATION_SYNCUSER
...
# This is the canonical definition; sync changes to backupmirror/common.sh
