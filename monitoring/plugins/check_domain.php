...
function check_domain($options) {
	...
	if (substr($options['domain'], -7) == '.com.au') {
		// As of May 2025 com.au no longer returns expiry dates.
	   	return;
	}
	if (substr($options['domain'], -7) == '.net.au') {
		// As of Sep 2025 com.au no longer returns expiry dates.
	   	return;
	}
